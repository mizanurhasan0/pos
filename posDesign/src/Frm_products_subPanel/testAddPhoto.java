 ...
 * @author world
 */
public class testAddPhoto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(imgShow, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 0, 200, 50));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel16, javax.swing.GroupLayout.PREFERRED_SIZE, 906, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jPanel15, javax.swing.GroupLayout.DEFAULT_SIZE, 906, Short.MAX_VALUE))
        ...
        if (jRadioButtonService.isSelected()) {
            if (txtimagePath1.equals(imagePathfield)) {
                ...
                addModel = new AddProductsModel(name, type, String.valueOf(manufacturer),
                        ...
                        selling_price, service_description,
                        jComboBoxVendorStatus.getSelectedItem().toString());
                System.out.println(name + " " + type + " " + String.valueOf(manufacturer) + " " + String.valueOf(vendor) + " "
                        + " " + selling_price + ", " + service_description + ","
                        + "" + jComboBoxVendorStatus.getSelectedItem().toString() + "," + imagePath);
    ...
    public boolean AddProducts() {
        ...
        try {
            ProductsEditModel model2 = new ProductsEditModel(
                    lbId.getText(), name, type, lbManufactureId.getText(),
                    lbVendorId1.getText(), lbunitId2.getText(), article_code,
                    article_name, operating_voltage, diameter_bore, stroke,
                    measuring_sensing, switching_output, sku, output_signal,
                    pp, selling_price, service_description, activeInactive);
    ...
    public boolean addProducts(ProductsEditModel model) {
        PreparedStatement pst = null;
        Connection con = new DbConnection().ConnDB();
        String sql = "INSERT INTO `products`(name,type,manufacturer,vendor,unit,article_code,article_name,"
                + "operating_voltage,diameter_bore,stroke,`measuring_sensing`,switching_output,sku,output_signal,"
                + "image,selling_price,service_description) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public void getDefaultPic() {
        try {
            File f;
            f = new File(imgShow.getIcon().toString());
    ...
    public void personPic(BufferedImage originalImage) {
        try {
            ...
            JOptionPane.showMessageDialog(this, "this is (personPic) :" + ex);
        }
    }
    ...
    private void btnDelete1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelete1ActionPerformed
        if (controller.deactiveProduct("products", lbId.getText()) == true) {
            ...
            ErrorJDialog1 errorDialog = new ErrorJDialog1(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testAddPhoto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testAddPhoto().setVisible(true);
            }
        });
    }
