...
//    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(Jpanel_list, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 220, 170));
        ...
        jTable_list.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Pur_Price", "QTY", "Total Price", "Total Paid", "Status", "Date", "VIEW", "DELETE"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        HashMap<String, String> setField = new HashMap<>();
        DateFormating formateDate = new DateFormating();
        String status = jComboBoxItemStatus.getSelectedItem().toString();
        setField.put("Status", jComboBoxItemStatus.getSelectedItem().toString());

        String StartDate = null;
        if (jDateChooser1.getDate() != null) {
            StartDate = formateDate.dateFormate(jDateChooser1.getDate());
            setField.put("StartDate", StartDate);
        }

        String EndDate = null;
        if (jDateChooser2.getDate() != null) {
            EndDate = formateDate.dateFormate(jDateChooser2.getDate());
            setField.put("EndDate", EndDate);
        } else {
            EndDate = formateDate.dateFormate(new Date());
        }
        ...
        setField.put("Search", txtSearch1);
        JOptionPane.showMessageDialog(null, EndDate + "" + StartDate);

        String sql = null;
        if (txtSearch1 != null && StartDate == null) {
            sql = "SELECT n.id,p.name,n.purchase_price,n.quantity,n.purchase_amount,n.purchase_paid,"
                    + "n.in_payment_complate,n.created FROM `inventory` as n,products as p WHERE "
                    + "n.product_id=p.id AND n.STATUS='" + status + "' AND (p.name LIKE '%" + txtSearch1 + "%') LIMIT 10";
        } else if (txtSearch1 != null && StartDate != null) {
            sql = "SELECT n.id,p.name,n.purchase_price,n.quantity,n.purchase_amount,n.purchase_paid,"
                    + "n.in_payment_complate,n.created FROM `inventory` as n,products as p WHERE "
                    + "n.product_id=p.id AND n.STATUS='" + status + "' AND (p.name LIKE '%" + txtSearch1 + "%' OR (n.created BETWEEN '" + StartDate + "' and '" + EndDate + "')) LIMIT 10";
        } else if (StartDate != null && txtSearch1 == null) {
            sql = "SELECT n.id,p.name,n.purchase_price,n.quantity,n.purchase_amount,n.purchase_paid,"
                    + "n.in_payment_complate,n.created FROM `inventory` as n,products as p WHERE "
                    + "n.product_id=p.id AND n.STATUS='" + status + "' AND (n.created BETWEEN '" + StartDate + "' and '" + EndDate + "') LIMIT 10";
        }
